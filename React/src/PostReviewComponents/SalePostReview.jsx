...
import "./SalePostReviewStyle.css";
...
const SalePostReview = (props) => {
  ...
  return (
    <div className="sale-post-review-frame">
      <div className="overlap-group-wrapper">
        <div className="overlap-group">
          ...
          <div className= "price-wrapper">{props.price}$</div>
          <div className="image" alt="Image" style={{backgroundImage: 'url(' + props.image + ')'}}  />
